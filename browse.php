<!-- This file contains all the code for the product view -->
<?php
    ...
    <form>
        <div id="FilterOptions">
            ...
            <input type="text" name="search_string" id="search_string"
                   ...
                   class="form-submit">
            <h4 class="FilterTopMargin"><i class="fas fa-list-ol"></i> Amount of product on page </h4>
    ...
    <a class="ListItem" href='view.php?id=<?php print $row['StockItemID']; ?>'>
            ...
            <!-- einde coderegel 1 van User story: bekijken producten   -->
                ...
                <div id="ProductFrame">
                    ...
                    <h1 class="StockItemID">SKU: <?php print $row["StockItemID"]; ?></h1>
...
<!-- einde code deel 4 van User story: Zoeken producten  -->
        ...
        <h2 id="NoSearchResults">
           Learn to search, we ain't got nothin'
        </h2>
        <?php
    }
    ?>
